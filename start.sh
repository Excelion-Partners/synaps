...
yarn start & sleep 30s ; startx /usr/app/electron/node_modules/electron/dist/electron /usr/app/electron --enable-logging ; cd /usr/app/socket/ && node index.js ; cd /usr/app/video-analysis && python3 main.py
