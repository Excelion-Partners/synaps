...
yarn start & sleep 30s ; cd /usr/app/video-analysis && python3 main.py ; cd /usr/app/socket/ && node index.js ; startx /usr/app/electron/node_modules/electron/dist/electron /usr/app/electron --enable-logging 
