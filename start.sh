...
yarn start & sleep 30s && startx /usr/src/signage/node_modules/electron/dist/electron /usr/src/signage --enable-logging & cd /usr/app/socket/ && node index.js & cd /usr/src/cv/ && sleep 20s && python3 Main.py
