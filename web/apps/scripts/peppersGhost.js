/**
 * Created by Matthew Pfluger on 2017-11-15
 *
 * peppers ghost effect based on https://github.com/mrdoob/three.js/blob/dev/examples/webgl_effects_peppersghost.html
 */
...
THREE.PeppersGhostEffect3 = function(renderer) {
    var scope = this;
